...
import { SiTypescript, SiStorybook, SiJest } from "react-icons/si";
...
const Home = () => {
  ...
  return (
    <div className="">
      ...
      <DiagonalBox width="200px" height="200px" />
    </div> */}
      <section className="flex justify-center items-enter rounded-lg"
      style={{
        backgroundColor: "#3B393A",
      }}>
        {/* // do the background orbs from luxebyte here as well */}
        <div className="relative grid place-items-center py-10 px-5 md:py-20">
          {/* <img
            src={headshottwo}
          ...
          /> */}
          <h1
            className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl font-bold uppercase z-0 drop-shadow-md"
            style={{
              color: green,
            }}
          >
          ...
          <h2 style={{ color: tan }}  className="mt-10 text-center texy-lg md:text-xl font-semibold max-w-[450px] mx-4">
      ...
      <section className="flex justify-center items-enter text-center mt-10 md:mt-20 px-4 md:px-8">
        <div className="mb-10">
          {/* abut me section  */}
          <h3 className="mb-4 text-5xl sm:text-6xl md:text-7xl lg:text-7xl uppercase text-center font-extrabold">
            software
            <br />
      ...
      {/* STATISTICS */}
      <section className="flex justify-center items-center px-4 md:px-8 gap-8 md:gap-14 text-center uppercase">
      ...
      <section className="flex justify-center items-enter text-center mt-10 md:mt-20 max-w-[800px] mx-auto">
        <div className="">
          <h3 className="mb-4 text-4xl sm:text-6xl md:text-7xl lg:text-7xl uppercase text-center font-extrabold">
            experience
          </h3>
          <div id="experience" className="">
            {experience.map((item) => (
              <div className="group" key={item.id}>
                ...
                >
                  <div className="p-4 md:p-8" style={{ color: '#888D91' }}>
                    <div className="flex items-center">
                      <p
                        className="text-xl text-left font-bold mb-1 group-hover:underline"
                        style={{ color: green }}
                      >
                        {item.role} -{' '}
              ...
              >
                ...
                >
                  ...
                  <div className="md:text-left">
                    ...
                    <p className="group-hover:text-gray-300 text-left" style={{ color: tan }}>
                      {item.description}
                    </p>
                  </div>
                </Link>
                ...
                <div key={post.id} className="group">
                    ...
                    >
                        <div className="p-4 lg:p-8" style={{ color: "#888D91" }}>
                            ...
                            <p className="mt-2 text-left group-hover:text-gray-300" style={{ color: tan }}>{post.description.slice(0,140)}...</p>
                        </div>
                    </a>
                </div>
            ))}
